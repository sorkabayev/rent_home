          ...
          child: Row(
            ...
            children: [
              ...
              MaterialButton(
                ...
                color: provider.checkMapSelect(isDisabled,Provider.of<AddressPageProvider>(context).street.isEmpty) ||
                    ...
                    : ColorService.main,
                textColor: provider.checkMapSelect(isDisabled,Provider.of<AddressPageProvider>(context).street.isEmpty) ||
                        provider.currentPageIndex == 7 &&
                            imageUploadProvider.imagesDownloadUrls.length < 5
                    ? Colors.black45
                    : Colors.white,
                ...
                disabledColor: provider.checkMapSelect(isDisabled,Provider.of<AddressPageProvider>(context).street.isEmpty) ||
                ...
                onPressed: provider.isLoading
                    ? null
                    : provider.checkMapSelect(isDisabled,Provider.of<AddressPageProvider>(context).street.isEmpty)
                        ? null
                        : provider.checkImageIsNull(
                            Provider.of<ImageUploadProvider>(context,
                                listen: false),
                            ...
                            : () async {
                                if (provider.currentPageIndex == 10) {
                                  ...
                                  await Provider.of<
                                    ...
                                    context,
                                    listen: false,
                                  ).sendHouseToFirebaseFirestore(context);
                                  provider.uploadIsLoading();

...
import 'package:rent_home/customer/view/login/sign_up/sign_up_fullname_page.dart';
import 'package:rent_home/customer/view/login/sign_up/sign_up_pin_code_page.dart';
...
class SignUpController extends ChangeNotifier {
  ...
  sendSMS(context, UserProvider providerUser) async {
    onTap = true;
    notifyListeners();
    String? result =
